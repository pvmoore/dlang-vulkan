...
nothrow:
    ...
    bool ImGui_ImplGlfw_ShouldChainCallback(GLFWwindow* window) {
        try{
    ...
    void ImGui_ImplGlfw_MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
    {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackMousebutton !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
    ...
    void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window, double xoffset, double yoffset) {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackScroll !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
...
//#endif
    ...
    void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int keycode, int scancode, int action, int mods)
    {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackKey !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
    ...
    void ImGui_ImplGlfw_WindowFocusCallback(GLFWwindow* window, int focused) {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackWindowFocus !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
    ...
    void ImGui_ImplGlfw_CursorPosCallback(GLFWwindow* window, double x, double y) {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackCursorPos !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
    ...
    void ImGui_ImplGlfw_CursorEnterCallback(GLFWwindow* window, int entered) {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackCursorEnter !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
    ...
    void ImGui_ImplGlfw_CharCallback(GLFWwindow* window, uint c)
    {
        try{
            ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
            if (bd.PrevUserCallbackChar !is null && ImGui_ImplGlfw_ShouldChainCallback(window))
...
bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    static if(_WIN32) {
        ...
        bd.PrevWndProc = cast(WNDPROC)GetWindowLongPtrW(cast(HWND)main_viewport.PlatformHandleRaw, GWLP_WNDPROC);
